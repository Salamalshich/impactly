    ...
    builder: (context) => StatefulBuilder(
      builder: (context, setState) {
        return AlertDialog(
          title: Text(
            pledge != null 
              ? AppLocalizations.of(context)!.update_pledge 
              : AppLocalizations.of(context)!.add_new_pledge
          ),
...
DialogDeletePledges(BuildContext context, Pledges Pledges) {
  showDialog(
    ...
    builder: (context) => StatefulBuilder(
      builder: (context, setState) {
        return AlertDialog(
          title: Text(AppLocalizations.of(context)!.delete_pledge),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.all(Radius.circular(20)),
          ),
          content: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: [
                  Text(
                    AppLocalizations.of(context)!.delete_pledge_confirmation,
          ...
          actions: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(AppLocalizations.of(context)!.delete, style: TextStyles.button),
                ),
              ),
            ),
            TextButton(
