                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.select_pledge_status,
                            style: TextStyles.title,
                          ),
                          Gap(5),
...
<<<<<<< HEAD
  ...
  DialogReportUser(BuildContext context, int id) async {
    final formkey = GlobalKey<FormState>();
    showDialog(
      context: context,
      builder:
          (context) => StatefulBuilder(
            builder: (context, setState) {
              return AlertDialog(
                title: Text(AppLocalizations.of(context)!.report_user),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(20)),
                ),
                content: SingleChildScrollView(
                  ...
                  GestureDetector(
                    onTap: () async {
                      if (formkey.currentState!.validate()) {
                        EasyLoading.show();
                        try {
                          Either<Failure, bool> result = await AddReport(
                            context,
                            id,
                          );
                          result.fold(
